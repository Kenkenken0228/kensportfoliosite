...
const Navbar = () => {
  ...
  return (
    <nav 
      className={ `${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 bg-more` }    
    >
      <div className="w-full flex justify-between items-center max-w-7xl mx-auto">
        ...
        font-bold cursor-pointer flex">Ken &nbsp; <span 
        className="sm:block hidden">| Yeung Ka Yue</span></p>
        </Link>
